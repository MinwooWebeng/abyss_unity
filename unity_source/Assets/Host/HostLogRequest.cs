...
namespace Host
{
    partial class Host
    {
        private void LogRequest(RenderAction render_action)
        {
            ...
            case RenderAction.InnerOneofCase.CreateImage: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.CreateImage)); return;
            case RenderAction.InnerOneofCase.DeleteImage: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.DeleteImage)); return;
            case RenderAction.InnerOneofCase.CreateMaterialV: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.CreateMaterialV)); return;
            case RenderAction.InnerOneofCase.CreateMaterialF: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.CreateMaterialF)); return;
            case RenderAction.InnerOneofCase.MaterialSetParamV: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.MaterialSetParamV)); return;
            case RenderAction.InnerOneofCase.MaterialSetParamC: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.MaterialSetParamC)); return;
            case RenderAction.InnerOneofCase.DeleteMaterial: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.DeleteMaterial)); return;
            case RenderAction.InnerOneofCase.CreateStaticMesh: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.CreateStaticMesh)); return;
            case RenderAction.InnerOneofCase.StaticMeshSetMaterial: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.StaticMeshSetMaterial)); return;
            case RenderAction.InnerOneofCase.ElemAttachStaticMesh: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.ElemAttachStaticMesh)); return;
            case RenderAction.InnerOneofCase.DeleteStaticMesh: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.DeleteStaticMesh)); return;
            case RenderAction.InnerOneofCase.CreateAnimation: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.CreateAnimation)); return;
            case RenderAction.InnerOneofCase.DeleteAnimation: GlobalDependency.Logger.Writer.WriteLine(FormatFlatLogLine(render_action.DeleteAnimation)); return;
